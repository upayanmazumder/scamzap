...
export default function QuizPage() {
  ...
  // Optionally: Save progress when quiz is completed
  useEffect(() => {
          ...
          {quizCompleted ? (
            ...
            <AnimatePresence mode="wait">
              {currentQuestion && (
                ...
                >
                  <div className="mb-6">
                    <h2 className="text-2xl font-semibold mb-2">{lesson.topic} - {quiz.topic}</h2>
                  ...
                  <ul className="space-y-3 mb-16">
                    {currentQuestion.options.map((option, idx) => {
                      ...
                      let optionClass = "cursor-pointer rounded-md border px-4 py-2 select-none";
                      if (showAnswer) {
                        if (isCorrect) {
